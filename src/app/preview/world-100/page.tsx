...
export default function WorldPreview(){
 ...
 return <><StatsNav/><LivePolling enabled={true}/><main className="mx-auto max-w-7xl space-y-10 px-5 py-10">
  ...
  <p className="text-xs text-muted">Historical counts are scoped to the verified samples shown. The previous entrant table’s “Eldora starts / wins” represented only quality-filtered retained races and has been removed because it could be mistaken for a complete career record.</p>
 </main></>;
}
